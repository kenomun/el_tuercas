...
class VehiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vehiculo" do
    assert_difference("Vehiculo.count") do
      post vehiculos_url, params: { vehiculo: { año: @vehiculo.año, marca: @vehiculo.marca, modelo: @vehiculo.modelo, patente: @vehiculo.patente, user_id: @vehiculo.user_id } }
    end
  ...
  test "should update vehiculo" do
    patch vehiculo_url(@vehiculo), params: { vehiculo: { año: @vehiculo.año, marca: @vehiculo.marca, modelo: @vehiculo.modelo, patente: @vehiculo.patente, user_id: @vehiculo.user_id } }
